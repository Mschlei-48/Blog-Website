...
function NavBar(){
    ...
    return (
        ...
        <Popup className="popup" trigger={<a className="nav-a"><FontAwesomeIcon icon={faUser} className="nav-icons" style={{color:"white",backgroundColor:"black",borderRadius:"25px",padding:"25%",width:"30px",height:"28px"}}/></a>}>
